...
※危険になろうとする性質の恐ろしさ：[キケントロピー増大の法則](https://h-oooka.github.io/hoaniinkai/low_of_kikentropy-increasing.html)

<span style="color:skyblue;">委員会では保安心得と次項プレゼンによるこれからの講習会のあり方を説明し、各委員会での取組みの是非を問う</span>

---

### 【保安】高圧ガスの保安心得と専用プレゼン
　*※前項「消費者保安講習会活性化」を、講習内容と教材の面から具体化するもの*

　- 心得として保安講習会活性につながる内容に変更
　
　- [プレゼンを配布可能にする](https://www.khks.net/2026/kokoroe_presenX-.pptx)
	...
	２章　それは警告として創られた言葉
	３章　｀みえていない｀ものを見るために
	４章　想像力（みえるちから）を持つ　壱、封じこめた力
	５章　想像力（みえるちから）を持つ　弐、常識の通じない異空間
	６章　想像力（みえるちから）を持つ　参、危険へ進む物
	７章　人の身で制御できるか
	８章　血で綴られた掟がある
	９章　慣れに呑まれるな
	10章　儲けたいならまず安全を掴め
...
　[英文周知文書のHTML展開](https://gassource.jp/shuchi_E/direct.html)の斟酌しない状態
...
　[安衛法関連リンク集を（全国通知のため）こちらのページに移動しました](https://h-oooka.github.io/hoaniinkai/annei_kagaku2026.html)
 ...
 ★委員会で質問のあった「SDSにも販売所の名称、住所、電話番号」は必要か、に対する説明もつけています。

　<span style="color:skyblue;">全国会員に対するアプローチについて具体策を委員会で提案を求める</span>

---

### 【経済】リスクアセスメント対象となった不活性ガス（高圧）
...
## おまけ
 ...
 [高圧ガスオリジナルソング集](https://khks.net/song/)
